...
var Achievements = {
	...
	"13" : {
		"Name" : "Have 10^14 Apple",
		"Description" : "Collect 10^14 Apple Wood",
		"Trigger" : func(): return SaveData.Resources["Apple"]["Count"] >= pow(10, 14),
	},
	"14" : {
		"Name" : "Have 10^16 Apple",
		"Description" : "Collect 10^16 Apple Wood",
		"Trigger" : func(): return SaveData.Resources["Apple"]["Count"] >= pow(10, 16),
	},
	"15" : {
		"Name" : "Have 10^17 Apple",
		"Description" : "Collect 10^17 Apple Wood",
	...
	"22" : {
		"Name" : "Have 10^17 Maple",
		"Description" : "Collect 10^17 Maple Wood",
	...
	"27" : {
		"Name" : "Have 10^12 Birch",
		"Description" : "Collect 10^12 Birch Wood",
		"Trigger" : func(): return SaveData.Resources["Birch"]["Count"] >= pow(10, 12),
	},
	"28" : {
		"Name" : "Have 10^13 Birch",
		"Description" : "Collect 10^13 Birch Wood",
	...
	"34" : {
		"Name" : "Have 10^13 Spruce",
		"Description" : "Collect 10^13 Spruce Wood",
		"Trigger" : func(): return SaveData.Resources["Spruce"]["Count"] >= pow(10, 13),
	},
	"35" : {
		"Name" : "Have 10^14 Spruce",
		"Description" : "Collect 10^14 Spruce Wood",
		"Trigger" : func(): return SaveData.Resources["Spruce"]["Count"] >= pow(10, 14),
	},
	"36" : {
		"Name" : "Have 10^16 Spruce",
		"Description" : "Collect 10^16 Spruce Wood",
	...
	"41" : {
		"Name" : "Have 10^11 Chestnut",
		"Description" : "Collect 10^11 Chestnut Wood",
		"Trigger" : func(): return SaveData.Resources["Chestnut"]["Count"] >= pow(10, 11),
	},
	"42" : {
		"Name" : "Have 10^13 Chestnut",
		"Description" : "Collect 10^13 Chestnut Wood",
		"Trigger" : func(): return SaveData.Resources["Chestnut"]["Count"] >= pow(10, 13),
	},
	"43" : {
		"Name" : "Have 10^15 Chestnut",
		"Description" : "Collect 10^15 Chestnut Wood",
	...
	"50" : {
		"Name" : "Have 10^15 Cherry",
		"Description" : "Collect 10^15 Cherry Wood",
	...
	"61" : {
		"Name" : "Have 10^12 Cedar",
		"Description" : "Collect 10^12 Cedar Wood",
	...
	"63" : {
		"Name" : "Have 10^14 Cedar",
		"Description" : "Collect 10^14 Cedar Wood",
	...
	"71" : {
		"Name" : "Have 10^16 Mahogany",
		"Description" : "Collect 10^16 Mahogany Wood",
	...
	"75" : {
		"Name" : "Have 10^12 Ebony",
		"Description" : "Collect 10^12 Ebony Wood",
		"Trigger" : func(): return SaveData.Resources["Ebony"]["Count"] >= pow(10, 12),
	},
	"76" : {
		"Name" : "Have 10^13 Ebony",
		"Description" : "Collect 10^13 Ebony Wood",
		"Trigger" : func(): return SaveData.Resources["Ebony"]["Count"] >= pow(10, 13),
	},
	"77" : {
		"Name" : "Have 10^16 Ebony",
		"Description" : "Collect 10^16 Ebony Wood",
		"Trigger" : func(): return SaveData.Resources["Ebony"]["Count"] >= pow(10, 16),
	},
	"78" : {
		"Name" : "Have 10^17 Ebony",
		"Description" : "Collect 10^17 Ebony Wood",
	...
	"147" : {
		"Name" : "Sell 750 Fish",
		"Description" : "Sell 750 Fish",
		"Trigger" : func(): return SaveData.GeneralInfo.has("FishSoldCount") and SaveData.GeneralInfo["FishSoldCount"] >= 750,
	},
	"148" : {
		"Name" : "Sell 2000 Fish",
	...
	"163" : {
		"Name" : "Fish 66 Times in One Ascension",
		"Description" : "Fish 66 Times in One Ascension",
		"Trigger" : func(): return SaveData.GeneralInfo.has("TempFishedCount") and SaveData.GeneralInfo["TempFishedCount"] >= 66,
	},
	"164" : {
		"Name" : "Fish 120 Times in One Ascension",
		"Description" : "Fish 120 Times in One Ascension",
		"Trigger" : func(): return SaveData.GeneralInfo.has("TempFishedCount") and SaveData.GeneralInfo["TempFishedCount"] >= 120,
	},
	"165" : {
		"Name" : "Fish 200 Times in One Ascension",
		"Description" : "Fish 200 Times in One Ascension",
		"Trigger" : func(): return SaveData.GeneralInfo.has("TempFishedCount") and SaveData.GeneralInfo["TempFishedCount"] >= 200,
	},
	"166" : {
	...
	"202" : {
		"Name" : "Total wood produced 10^6",
		"Description" : "Total wood produced by woodcamps 10^6",
	...
	"203" : {
		...
		"Description" : "Total wood produced by woodcamps 10^9",
	...
	"204" : {
		...
		"Description" : "Total wood produced by woodcamps 10^12",
	...
	"206" : {
		"Name" : "Total wood produced 10^16",
		"Description" : "Total wood produced by woodcamps 10^16",
	...
	"208" : {
		"Name" : "Total wood produced 10^18",
		"Description" : "Total wood produced by woodcamps 10^18",
		"Trigger" : func(): return SaveData.GeneralInfo.has("TotalWoodProduced") and SaveData.GeneralInfo["TotalWoodProduced"] >= pow(10, 18),
	},
	"209" : {
		"Name" : "Total wood produced 10^19",
		"Description" : "Total wood produced by woodcamps 10^19",
