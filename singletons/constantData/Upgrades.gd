...
var Upgrades = {
	"Oak" : {
		...
		"8" :  {
			...
			"Description" : "",
			"OtherText" : "",
			"Unlocked" : Unlocks && Unlocks.Unlocks["Dams"]["Unlocked"],
		},
		"9" :  {
			"Name" : "1% Faster Research",
			"Description" : "",
			"OtherText" : "",
			"Unlocked" : Unlocks && Unlocks.Unlocks["Research"]["Unlocked"],
		},
		"10" :  {
	...
	"Apple" : {
		...
		"10" :  {
			...
			"Description" : "",
			"OtherText" : "",
			"Unlocked" : Unlocks && Unlocks.Unlocks["Fishing"]["Unlocked"],
		},
	},
	"Maple" : {
		"1" : {
		...
		"8" :  {
			...
			"Description" : "",
			"OtherText" : "",
			"Unlocked" : Unlocks && Unlocks.Unlocks["Market"]["Bots"]["Unlocked"],
		},
		"9" :  {
		...
		"10" :  {
			...
			"Description" : "",
			"OtherText" : "",
			"Unlocked" : Unlocks && Unlocks.Unlocks["Magic"]["Ascention"],
		},
	},
	"Birch" : {
		"1" : {
		...
		"8" :  {
			...
			"Description" : "",
			"OtherText" : "",
			"Unlocked" : Unlocks && Unlocks.Unlocks["Fishing"]["Bait"]["Unlocked"],
		},
		"9" :  {
			"Name" : "3% Cheaper Bots",
			"Description" : "",
	...
	"Dogwood" : {
		...
		"9" :  {
			...
			"Description" : "",
			"OtherText" : "",
			"Needed" : Unlocks && Unlocks.Unlocks["Fishing"]["Unlocked"],
		},
		"10" :  {
